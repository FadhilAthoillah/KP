    ...
    <div class="container">
      ...
      <table class="table table-bordered" id="example">
        ...
        <tbody>
          <?php $nomor=1; ?>
          <?php 
            $ambil = mysqli_query($koneksi, 'SELECT * FROM pemesanan_di_tempat');
          ...
          <tr>
            ...
            <td>
              ...
              <a href="detail_pesanan_di_tempat.php?id=<?php echo $result['id_pemesanan'] ?>" class="badge badge-primary">Detail</a>
