...
<html lang="en">
  ...
  <!-- Navbar -->
      <nav class="navbar navbar-expand-lg  bg-dark">
        <div class="container">
        <a class="navbar-brand text-white" href="admin.php"><strong>Kedai</strong> Lais Coffe</a>
    ...
    <div class="container">
      ...
      <table class="table table-bordered" id="example">
        ...
        <tbody>
          ...
          <?php $totalbelanja = 0; ?>
          <?php 
              $ambil = $koneksi->query("SELECT * FROM pemesanan_produk_di_tempat JOIN produk ON pemesanan_produk_di_tempat.id_menu=produk.id_menu 
                WHERE pemesanan_produk_di_tempat.id_pemesanan='$_GET[id]'");
           ?>
      ...
      <?php 
        if(isset($_POST["bayar"]))
        {
          ...
          echo "<script>location= 'pesanan_di_tempat.php'</script>";
        }
      ?>
