      ...
      <table class="table table-bordered" id="example">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><?php echo $result["nomor_transaksi"]; ?></td>
            <td><?php echo $result["tanggal_pemesanan"]; ?></td>
            <td>Rp. <?php echo number_format($result["total_belanja"]); ?></td>
            <td>
              <?php
                if($result['status'] == "Menunggu Konfirmasi") {
                  echo "<a href='ubah_status.php?id=$result[id_pemesanan]' class='badge badge-info'>Konfirmasi Pembayaran</a>";
                } else if($result['status'] == "Dikemas") {
                  echo "<a href='ubah_status.php?id=$result[id_pemesanan]' class='badge badge-warning text-white'>Kirim Pesanan</a>";
                } else if($result['status'] == "Dikirim") {
                  echo "<a href='#' class='badge badge-secondary' disabled>Pesanan Dikirim</a>";
                } else {
                  echo "<a href='#' class='badge badge-success' disabled>Pesanan Selesai</a>";
                }
              ?>
