...
<html lang="en">
  ...
  <!-- Jumbotron -->
      <div class="jumbotron jumbotron-fluid text-center">
        <div class="container">
          <h1 class="display-4"><span class="font-weight-bold">KEDAI LAIS COFFE</span></h1>
          <hr>
  ...
  <!-- Navbar -->
      <nav class="navbar navbar-expand-lg  bg-dark">
        <div class="container">
        <a class="navbar-brand text-white" href="user.php"><strong>Kedai</strong> Lais Coffe</a>
  ...
  <!-- Menu -->
    <div class="container">
      ...
      if(isset($_POST['konfirm'])) {
          ...
          $insert = mysqli_query($koneksi, "INSERT INTO pemesanan_di_tempat (tanggal_pemesanan, total_belanja) VALUES ('$tanggal_pemesanan', '$totalbelanja')");
          ...
          {
            $insert = mysqli_query($koneksi, "INSERT INTO pemesanan_produk_di_tempat (id_pemesanan, id_menu, jumlah) 
